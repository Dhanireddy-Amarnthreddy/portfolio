...
const About = () => (
  <section id="about">
    ...
    <ul>
      ...
      <li>Did an one month internship in Edify Techno Solutions on Machine learning. </li>
      <li>Languages known are English, Tamil and Telugu.</li>
      <li>My hobbies are to play board games and watch series and movies.</li>
    </ul>
  </section>
);
